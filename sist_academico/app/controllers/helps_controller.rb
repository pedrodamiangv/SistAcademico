...
class HelpsController < ApplicationController
  ...
  def index
    ...
    @link_helps=[
      ...
      "Para poder ver el perfil del alumno, vaya al menu cuenta, y haz click en Perfil. Esto te muestra el perfil del usuario logueado con todos sus datos que puede ser un alumno, docente y/o administrativo, ademas de ver tu perfil puedes editar algunos campos haciendo click en la opcion Editar que se encuentra en el lado izquierdo especificamente debajo del nombre del usuario logueado. O directamente puedes ir al menu Cuenta, Editar Perfil y alli obtienes los campos de tu perfil que quieras editar.",
