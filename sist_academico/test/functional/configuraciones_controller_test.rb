...
class ConfiguracionesControllerTest < ActionController::TestCase
  ...
  test "should create configuracion" do
    assert_difference('Configuracion.count') do
      post :create, configuracion: { ciudad: @configuracion.ciudad, departamento: @configuracion.departamento, direccion: @configuracion.direccion, email: @configuracion.email, logo: @configuracion.logo, nombre: @configuracion.nombre, telefono: @configuracion.telefono }
    end
  ...
  test "should update configuracion" do
    put :update, id: @configuracion, configuracion: { ciudad: @configuracion.ciudad, departamento: @configuracion.departamento, direccion: @configuracion.direccion, email: @configuracion.email, logo: @configuracion.logo, nombre: @configuracion.nombre, telefono: @configuracion.telefono }
    assert_redirected_to configuracion_path(assigns(:configuracion))
  end
