...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { curso: @curso.curso, enfasis: @curso.enfasis, nivel: @curso.nivel, turno: @curso.turno }
    end
  ...
  test "should update curso" do
    put :update, id: @curso, curso: { curso: @curso.curso, enfasis: @curso.enfasis, nivel: @curso.nivel, turno: @curso.turno }
    assert_redirected_to curso_path(assigns(:curso))
  end
