...
class DocentesControllerTest < ActionController::TestCase
  ...
  test "should create docente" do
    assert_difference('Docente.count') do
      post :create, docente: { matricula: @docente.matricula, titulo: @docente.titulo, user_id: @docente.user_id }
    end
  ...
  test "should update docente" do
    put :update, id: @docente, docente: { matricula: @docente.matricula, titulo: @docente.titulo, user_id: @docente.user_id }
    assert_redirected_to docente_path(assigns(:docente))
  end
